        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <FadeIn direction="right" className="space-y-8">
            <div className="flex gap-4 p-5 rounded-xl border border-border bg-card">
              <div className="p-2.5 rounded-lg bg-[#19a3ff]/10 h-fit">
              ...
              <div className="flex gap-3">
                {socialLinks.map(({ name, url, Icon }) => (
                  <a
                    ...
                    aria-label={name}
                    className="p-3 rounded-xl border border-border bg-card text-muted-foreground hover:text-[#19a3ff] hover:border-[#19a3ff]/30 transition-colors"
                  >
